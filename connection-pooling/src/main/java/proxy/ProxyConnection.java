...
/**
 * We have Decorator Pattern here.
 */
...
public class ProxyConnection implements Connection {
    ...
    public ProxyConnection(final Connection connection, final IConnectionPool iConnectionPool) {
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        return ProxyFactory.getProxyCallableStatement(delegate, delegate.prepareCall(sql));
    }
    ...
    public synchronized void close() throws SQLException {
        ...
        iConnectionPool.releaseConnection(delegate);
        delegate=null;
    }
