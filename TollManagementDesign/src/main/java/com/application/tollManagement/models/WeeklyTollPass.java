...
public class WeeklyTollPass extends TollPass {

    public WeeklyTollPass(double charges, Integer tollBoothID, String regNo, VehicleType vehicleType, TollPassType tollPassType) {
